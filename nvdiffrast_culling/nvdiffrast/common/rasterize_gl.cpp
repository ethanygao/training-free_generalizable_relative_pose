...
void rasterizeResizeBuffers(NVDR_CTX_ARGS, RasterizeGLState& s, bool& changes, int posCount, int triCount, int width, int height, int depth, int backface_culling)
{
    changes = false;
    ...
    else
    {
        ...
        glCullFace(backface_culling==1?GL_BACK:GL_FRONT);
    }
