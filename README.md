...
### 3. Compile `gaussian_filter`
```
cd gaussian_filter
python setup.py install --user
```

### 4. Download Pretrained DINOv2 Model
```
mkdir third_party
cd third_party
...
wget https://huggingface.co/datasets/bop-benchmark/lm/resolve/main/lm_test_all.zip  #LineMOD real image datasets
unzip lm_test_all.zip
```

### 6. Query-Reference Pairs Generation
